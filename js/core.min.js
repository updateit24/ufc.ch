...
function loadContent(url, n) {
    // Realiza una solicitud AJAX para obtener el contenido
    $.ajax({
        url: url,
        method: 'GET',
        success: function(data) {
            // Reemplaza el contenido de la página con los datos recibidos
            n.page.html(data);
            // Ejecuta cualquier código adicional que necesites
            n.page.fadeIn(n.animDuration); // Ejemplo de animación
        },
        error: function() {
...
// Maneja el evento popstate para retroceder
$(window).on('popstate', function(event) {
    if (event.originalEvent.state) {
        // Cargar contenido según la ruta almacenada
        loadContent(event.originalEvent.state.path, n);
    } else {
        // Manejar la situación cuando no hay estado
        loadContent(window.location.pathname, n);
    }
});
