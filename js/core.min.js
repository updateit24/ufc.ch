...
function pageTransition(n){
    ...
    $("a").click(function(a){
        ...
        if (n.conditions(a, t)) {
            ...
            // Remove animIn class, add animOut class for the transition
            n.page.removeClass(n.animIn).addClass(n.animOut);

            // Handle the page transition with history.pushState and reload
            setTimeout(function() {
                // Update the browser's URL without reloading
                window.history.pushState({}, '', e);
                
                // Optionally reload the page to fetch the new content
                window.location.reload();

                // Browser-specific handling for Firefox and Safari
                /firefox/i.test(navigator.userAgent) && setTimeout(function() {
                    n.page.removeClass(n.animOut);
                }, 1000);

                /safari/i.test(navigator.userAgent) && !/chrome/i.test(navigator.userAgent) && n.page.removeClass(n.animOut);
            }, n.animDuration);
        }
    });
}
